...
<div id="layoutSidenav_content">
        ...
        <div class="header">
            ...
            <div class="hero-right">
                    <img src="./img/3.webp" alt="toko">
                </div>
                <!-- Filter Form -->
                <form method="GET" class="mb-4">
                    <div class="row">    
                <?php
                $get = mysqli_query($c, "select * from toko");
                ...
                while($p=mysqli_fetch_array($get)){
                    ...
                    $notelp = $p['telepon'];
                    $alamat = $p['alamattoko'];
                    $pemiliktoko = $p['pemilik'];

                ?>
                <form class="mt-4">
                    <div class="mb-3">
                        <label for="namatoko" class="form-label">Nama Toko</label>
                        <input type="text" class="form-control" id="namatoko" value="<?=$namatoko;?>" readonly>                    
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="pemilik" class="form-label">Username</label>
                        <input type="text" class="form-control" id="pemilik" value="<?=$pemiliktoko;?>" readonly>
                    </div>                      
                <?php
                };
                ?>
